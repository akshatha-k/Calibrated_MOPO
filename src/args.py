...
parser.add_argument("--task_hor", default=5, type=int)  # default was 200
...
# Exp parameters
parser.add_argument("--ntrain_iters", default=5, type=int)  # def was 50
...
parser.add_argument("--plan_hor", default=5, type=int)  # default was 25
parser.add_argument(
...
parser.add_argument("--popsize", default=5, type=int)  # default was 400
parser.add_argument("--num_elites", default=2, type=int)  # default was 40
parser.add_argument("--epsilon", default=0.1, type=float)  # check default value
parser.add_argument("--alpha", default=0.1, type=float)

parser.add_argument("--n_record", default=10, type=int)  # default was 100
