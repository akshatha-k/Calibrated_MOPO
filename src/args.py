...
parser.add_argument("--mujoco", default=False, type=bool, help="Use Mujoco?")
# Model Parameters
...
parser.add_argument("--epochs", default=2, type=int)  # check if epochs is ntrain_iters
# Trainer Parameters
parser.add_argument("--batch_size", default=1, type=int, help="batch_size to use")
parser.add_argument("--calibrate", default=False, type=bool, help="To calibrate?")

# Experiment parameters
parser.add_argument("--env", default="cartpole", type=str)
# Simulator Parameters
parser.add_argument("--task_hor", default=100, type=int)  # default was 200
...
# Exp parameters
parser.add_argument("--ntrain_iters", default=25, type=int)  # def was 50
...
parser.add_argument("--plan_hor", default=15, type=int)  # default was 25
parser.add_argument(
...
parser.add_argument("--popsize", default=200, type=int)  # default was 400
parser.add_argument("--num_elites", default=20, type=int)  # default was 40
parser.add_argument("--epsilon", default=0.1, type=float)  # check default value
parser.add_argument("--alpha", default=0.1, type=float)

parser.add_argument("--n_record", default=50, type=int)  # default was 100
